...
class ATSScorer:
    ...
    def compute_ats_score(self, resume_data: Dict, job_description: str, 
        ...
        sbert_score = self._compute_sbert_similarity(resume_text, job_description)
        tfidf_score = self._compute_tfidf_similarity(resume_text, job_description)
        layout_score = analysis_results.get('layout_score', 0.5) if analysis_results else 0.5
    ...
    def _analyze_skill_gaps(self, resume_text: str, job_description: str) -> Dict[str, Any]:
        ...
        skill_match_percentage = len(matching_skills) / total_jd_skills if total_jd_skills > 0 else 0
    ...
    def _analyze_keyword_matching(self, resume_text: str, job_description: str) -> Dict[str, Any]:
        ...
        keyword_density = len(matched_keywords) / len(jd_keywords) if jd_keywords else 0
    ...
    def calculate_match_score_by_section(self, resume_data: Dict, 
        ...
        for section in resume_sections:
            ...
            if section_match:
                ...
                section_scores[section] = matches / total_possible if total_possible > 0 else 0
            else:
    ...
    def analyze_ats_compliance(self, resume_data: Dict) -> Dict[str, Any]:
        ...
        compliance_report = {
            ...
            'passed_checks': [k for k, v in compliance_checks.items() if v['score'] >= 0.8],
            'failed_checks': [k for k, v in compliance_checks.items() if v['score'] < 0.6],
    ...
    def _check_standard_sections(self, sections: List[str]) -> Dict[str, Any]:
        ...
        score = (required_present / len(required_sections)) * 0.8 + \
                (optional_present / len(optional_sections)) * 0.2
    ...
    def _check_contact_info(self, contact_info: Dict) -> Dict[str, Any]:
        ...
        score = (required_present / len(required_fields)) * 0.8 + \
                (optional_present / len(optional_fields)) * 0.2
    ...
    def _check_formatting_compliance(self, text: str) -> Dict[str, Any]:
        ...
        score = max(0, (total_checks - issues) / total_checks)
    ...
    def _check_keyword_usage(self, text: str) -> Dict[str, Any]:
        ...
        keyword_density = keyword_count / words if words > 0 else 0
